const TermsOfService = () => {
  return (
    <div>
      ...
      <p>Our Terms of Service were last updated on 2023-02-15.</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Terms of Service</strong> (also referred as Terms or Terms
            of Service) mean these Terms of Service that form the entire
      ...
      <p>
        ...
        copyright agent via email (mydezktop@gmail.com) and include in Your
      ...
      <p>
        You can contact our copyright agent via email (mydezktop@gmail.com).
      ...
      <p>
        ...
        party`&apos;`s ability to exercise such right or require such
