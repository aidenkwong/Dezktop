const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>Our Privacy Policy was last updated on 2023-02-15.</p>
      <p>
      ...
      <ul>
        <li>
          ...
          https://dezktop.vercel.app/contact-us
        </li>
        <li>By sending us an email: mydezktop@gmail.com</li>
      </ul>
      <p>
